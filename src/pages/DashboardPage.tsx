...
import {
  FileText, TrendingUp, ShoppingBag, Bell,
...
function StatCard({ label, value, icon: Icon, change, accent, index }: StatCardProps) {
  return (
    <motion.div
      variants={fadeUp}
      custom={index}
...
export function DashboardPage() {
  ...
  const statCards: Omit<StatCardProps, 'index'>[] = [
    { label: 'Mes Demandes', value: 12, icon: FileText, accent: 'bg-amber-500', change: '+3' },
    { label: 'Offres Reçues', value: 48, icon: ShoppingBag, accent: 'bg-blue-500', change: '+8' },
    { label: 'En Négociation', value: 5, icon: TrendingUp, accent: 'bg-emerald-500', change: '+2' },
    { label: 'Notifications', value: 3, icon: Bell, accent: 'bg-violet-500', change: '+1' },
  ];
            ...
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-xs mt-0.5">Demandes & offres sur 7 jours</CardDescription>
                </div>
            ...
            <CardContent>
              ...
              <ResponsiveContainer width="100%" height={200}>
                <AreaChart data={activityData} margin={{ top: 4, right: 4, bottom: 0, left: -20 }}>
                  ...
                  <Area type="monotone" dataKey="offres" stroke="#111111" strokeWidth={2} fill="url(#gradOffres)" name="Offres" />
                </AreaChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
